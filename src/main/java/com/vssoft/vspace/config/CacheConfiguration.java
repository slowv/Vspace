...
import com.vssoft.vspace.config.cache.PrefixedKeyGenerator;
...
public class CacheConfiguration {
    ...
    @Bean
    public javax.cache.configuration.Configuration<Object, Object> jcacheConfiguration(VSpaceProperties properties) {
