...
/**
 * REST controller for managing global OIDC.
 */
@RestController
...
public class AuthenticationResource {
    ...
    public AuthenticationResource(ClientRegistrationRepository registrations) {
     ...
     */
    @PostMapping("/logout")
    public ResponseEntity<Map<String, Object>> logout(HttpServletRequest request, @AuthenticationPrincipal(expression = "idToken") OidcIdToken idToken) {
